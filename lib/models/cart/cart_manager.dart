...
import 'package:ecommerce_app/services/cepaberto_service.dart';
  ...
  Future<void> getAddress(String cep) async {
    ...
    try {
      ...
      if (cepAbertoAddress != null) {
        address = Address(
            street: cepAbertoAddress.logradouro as String,
            district: cepAbertoAddress.bairro as String,
            zipCode: cepAbertoAddress.cep as String,
            city: cepAbertoAddress.cidade.nome as String,
            state: cepAbertoAddress.estado.sigla as String,
            lat: cepAbertoAddress.latitude as double,
            long: cepAbertoAddress.longitude as double);
      }
      loading = false;
    } catch (e) {
      loading = false;
